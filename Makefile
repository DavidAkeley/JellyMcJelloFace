...
CC = cc $(FLAGS) -std=c++14 -S
CPP = c++ $(FLAGS) -std=c++14 -S
...
JellyMcJelloFace: client.s jellymjf.s
	$(LINKER) client.s jellymjf.s -o JellyMcJelloFace -lGL -lSDL2

client.s: client.cc vec3.h vec3-fallback.inc jellymjf.h beadface.h opengl-functions.inc
	$(CPP) client.cc -o client.s

jellymjf.s: jellymjf.cc vec3.h dvec3.hpp vec3-fallback.inc jellymjf.h
	$(CPP) jellymjf.cc -o jellymjf.s
